...
Add ::= Mul (PLUS Mul)*
Mul::= Atom (TIMES Atom)*
Atom ::= FST Atom | SND Atom | MINUS Atom | BOOL | NUM | IDENT | NOT | OPEN_PAR Exp CLOSE_PAR
*/
...
public class Parser implements ParserInterface {
	...
	/*
	 * parses expressions, starting from the lowest precedence operator ADD
	 * which is left-associative
	 * And :== Eq (AND Eq)*
	 */
	...
	/*
	 * parses esxpressions with unary operator NOT
	 * Atom :== NOT Atom
	 */
