...
public interface Visitor<T> {
	...
	T visitAssignStmt(Variable var, Exp exp); // Aggiunta del visitor di Assign

	T visitAssertStmt(Exp exp); // aggiunta del visitor di Assert
	...
	T visitAnd(Exp left, Exp right); // aggiunta del visitor di And
